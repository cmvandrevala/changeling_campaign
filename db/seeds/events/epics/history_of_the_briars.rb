...
Event.last.characters << Character.where(name: "The Kidnapped Child").take
Location.where(name: "Arcaida").take.events << Event.last
...
Event.last.characters << Character.where(name: "The Hag").take
Event.last.characters << Character.where(name: "The Hat").take
Event.last.characters << Character.where(name: "The Hero").take
