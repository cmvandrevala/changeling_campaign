...
Event.create({
  name: "The Third Congress",
  date: Date.new(1985,5,25),
  description: "The four changelings meet up to discuss their goals. They feel a sense of power while they are together. Perhaps this is a sign that they can change the world for the better."
})
Event.last.characters << Character.where(name: "Issac Corvi").take
Event.last.characters << Character.where(name: "Aldric Durant").take
Event.last.characters << Character.where(name: "Fredrick Ackerley").take
...
Event.create({
  name: "Nothing to Fear But Fear Itself",
...
Event.create({
  ...
  description: "The second act of The Jester is to arrest Vulpecula - Issac's most trusted adviser - for aiding and abetting a criminal. Vulpecula manages to escape before the guard catches him."
})
Event.last.characters << Character.where(name: "The Jester").take
