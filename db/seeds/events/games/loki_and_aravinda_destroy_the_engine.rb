...
#
# Event.create({
#   title: "The Trickster Returns Home",
...
#   location: "Anansesam City"
# })
# Event.last.characters << Character.where(name: "Loki").take
#
# Event.create({
#   title: "The Stone Slab Encounter",
...
#
# Event.create({
#   title: "The Mistletoe Pact",
#   date: Date.new(2013,12,21),
#   description: "Loki meets with the newly crowned Winter Monarch and gets the deal he desires (for the most part). As per the arrangement, he tries to kill The Kidnapped Child, but cannot figure out if he actually succeeds. In any case, he finally finds the library.",
#   location: "Anansesam City"
# })
# Event.last.characters << Character.where(name: "Loki").take
# Event.last.characters << Character.where(name: "Aldric Durant").take
#
# Event.create({
#   title: "The Honey Trap Encounter",
#   date: Date.new(2013,12,22),
#   description: "Loki and the party meet under the Honey Trap while being watched by Changlings. It's very awkward. Loki manages to avoid the party and the changlings and get the Atlas through a combination of skill and blind luck. Loki's biggest challenge is to keep from laughing at the situation during the encounter.",
#   location: "Anansesam City"
# })
# Event.last.characters << Character.where(name: "Loki").take
