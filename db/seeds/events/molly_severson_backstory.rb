...
Event.last.location = Location.where(name: "Lower East Side").take
...
Event.last.characters << Character.where(name: "Molly Severson").take
Event.last.location = Location.where(name: "Columbia University").take
...
Event.last.characters << Character.where(name: "Molly Severson").take
Event.last.location = Location.where(name: "The Laddered Forest").take
